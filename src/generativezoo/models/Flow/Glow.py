    ...
    def train_model(self,dataloader, args, verbose=True):
        ...
        for epoch in epoch_bar:
            ...
            if total_loss < best_loss:
                ...
                torch.save(self.state_dict(), os.path.join(models_dir,'Glow', f"Glow_{self.dataset}.pt"))
                self.load_state_dict(torch.load(os.path.join(models_dir,'Glow', f"Glow_{self.dataset}.pt")))
